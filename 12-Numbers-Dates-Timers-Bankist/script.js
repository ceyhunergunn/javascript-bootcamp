...
console.log(Math.max(2, 123, 34, '256', 126));
console.log(Math.min(2, 123, 34, '256', 126));
...
const diameter = 312_300_012_300;
...
console.log(192374918249812943819842934891234n);
console.log(BigInt(192374918249812943819842934891234));
//operations
console.log(1000n + 1000n);

console.log(98234981293489123123412384n * 10000n);

const huge = 1273981239812938912893812n;
const num = 23;
...
console.log(new Date('Sat Feb 10 2024 15:26:54'));
...
console.log(new Date(1707568609282));
console.log(Date.now());

console.log(date.setFullYear(2029));
